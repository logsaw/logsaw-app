 ...
 * @author Philipp Nanz
 */
public class MessageFieldView extends ALogEntryFieldView {

	/**
	 * The ID of the view as specified by the extension.
	 */
	public static final String ID = "net.sf.logsaw.ui.views.MessageFieldView"; //$NON-NLS-1$
	...
	protected StringLogEntryField getFieldToDisplay(ILogDialect dialect) {
		return dialect.getFieldProvider().getMessageField();
	}
}
